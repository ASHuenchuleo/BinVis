...
@Component({
  selector: 'app-single-orbit-manager',
  templateUrl: './single-orbit-manager.component.html',
  styleUrls: ['./single-orbit-manager.component.css']
})
export class SingleOrbitManagerComponent {
	/**
	* Recieves the orbit parameters, data and configuration and
	* calculates the trayectory for a singular orbit
	*/
    /** Orbit solver */
