...
export class InputComponent {
  ...
  @ViewChild(PropertyInputComponent, {static: true}) propertyInputChild;
  @ViewChild(ViewSelectionComponent, {static: true}) viewSelectionChild;
  @ViewChild(FileInputComponent, {static: true}) fileInputChild;
  ...
  */
  ...
  updateViews() {
    let attributes = this.propertyInputChild.visualAttributes.concat(
      this.propertyInputChild.physicalAttributes.concat(
        this.propertyInputChild.measuredAttributes));
